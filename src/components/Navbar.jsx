...
const Navbar = () => {
  return (
    <>
      <div className="sm:w-11/12 md:w-3/4 lg:w-2/3 mx-auto mt-10 p-6 rounded-2xl bg-linear-to-r from-indigo-100 via-purple-100 to-blue-100 shadow-2xl">
        <h1 className="text-center text-4xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-blue-500 via-purple-600 to-indigo-500">
